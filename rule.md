...
제3조 (회원가입 및 자격)
만19세 ~ 만60세의 성인 남녀 중 '로드 자전거'를 이용하는 누구나 공식 카페에 가입 후 가입인사의 성실한 작성 및 닉네임 변경 등 정해진 규정을 준수하고 승인을 얻음으로써 회원의 자격을 획득한다. 본인이 자진 탈퇴하거나 징계에 의한 강퇴 처분을 받았을 경우에는 그 자격을 상실한다.


## 제4조 (회원등급)
라이딩 클럽 라라의 회원등급은 아래와 같다
· 손님 : 공식카페에 가입후 관리자 가입승인을 득한 회원
· 도도 라이더 : 가이드를 준수한 가입인사말을 작성한 회원
· 레레 라이더 : 오프라인 라이딩 모임에 1회 이상 참석한 회원
...
(1) 클럽 가입 후, 24시간 내에 가입인사 작성과 닉네임 변경을 하지 않은 회원(강제탈퇴)
...
각 보직자의 역할은 아래와 같다
·의장 : 클럽장, 동호회를 대외적으로 대표하며 분쟁 시 중재의 역할
·재무담당 : 클럽 회비 관리, 총무
...
2. 라이딩 참가자는 일정 및 코스 등 모임 주최자(벙짱)의 진행에 적극 협조한다.
...
1.라이딩 모임은 로드 자전거로 한정하며 주최는 미미 라이더 등급 이상의 회원이면 가능하다.
